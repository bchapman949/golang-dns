...
import (
	...
	"github.com/bchapman949/golang-dns/hostsfile"
	"github.com/bchapman949/golang-dns/resolvconf"
	"github.com/bchapman949/golang-dns/server"
	"github.com/bchapman949/golang-dns/stats"
)
...
func main() {
	...
	app.Name = "golang-dns"
	app.Usage = "DNS Cache"
	app.UsageText = "golang-dns [global options]"
	app.Version = Version
	app.Author, app.Email = "", ""
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "listen, l",
			Value:  "127.0.0.1:8853",
